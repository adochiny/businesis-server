...
public class Asset extends BasePo {

    // 0001-0001-0056/ Desktop/Acer/Veriton 3300Pro
    //http://www.cnet.com/products/acer-veriton-3900pro-core-2-duo-e4300-1-86-ghz-monitor-none-series/specs/
    @Id
    ...
    // Many asset to 1 software
    @ManyToOne(optional=true,
            cascade = {CascadeType.ALL},fetch=FetchType.EAGER)
    @JoinColumn(name="warehouse_id",referencedColumnName="warehouse_id")
    private Warehouse warehouse;

    // mapped to assetCode., Many assets to 1 assetcode
    @ManyToOne(optional=false,
            cascade = {CascadeType.ALL},fetch=FetchType.EAGER)
    @JoinColumn(name="asset_code_id",referencedColumnName="asset_code_id")
    private AssetCode assetCode;

    // Many asset to 1 software
    @ManyToOne(optional=false,
            cascade = {CascadeType.ALL},fetch=FetchType.EAGER)
    @JoinColumn(name="asset_software_id",referencedColumnName="asset_software_id")
    private AssetSoftware assetSoftware;

    // mapped to attributes. 1 to many.
    @OneToMany(mappedBy="asset",targetEntity=Attribute.class,
            cascade = {CascadeType.ALL},fetch=FetchType.EAGER)
    private List<Attribute> attributes = new ArrayList<>();

    // mapped to asset-warehouses. 1 to many.
    /*@OneToMany(mappedBy="asset",targetEntity=AssetWarehouse.class,
            cascade = {CascadeType.ALL},fetch=FetchType.EAGER)
    private List<AssetWarehouse> assetWarehouses = new ArrayList<>();*/
